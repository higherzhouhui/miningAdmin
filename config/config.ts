    ...
    },
    {
      ...
      routes: [
        ...
        },
        {
          name: 'country-list',
          path: '/anchor/country',
          component: './anchor/country',
          access: 'adminRouteFilter',
        },
        {
          name: 'language-list',
          path: '/anchor/language',
          component: './anchor/language',
          access: 'adminRouteFilter',
        },
        {
          name: 'style-list',
          path: '/anchor/style',
          component: './anchor/style',
          access: 'adminRouteFilter',
        },
        {
          name: 'group-list',
          path: '/anchor/group',
          component: './anchor/group',
          access: 'adminRouteFilter',
        },
      ],
    },
