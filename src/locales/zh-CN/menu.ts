export default {
  ...
  'menu.datamanage.datamanage-eventlist': '系统日志',
  'menu.datamanage.datamanage-prizelist': '奖品列表',
  'menu.datamanage.datamanage-rewardlist': '签到奖励列表',
  'menu.datamanage.datamanage-tasklist': '任务列表',
  ...
  'menu.financial.consumption': 'Coins使用记录',
  ...
  'menu.account.account-follow': '关注主播',
  'menu.account.account-chat': '视频过主播',
  'menu.account.account-propslist': '用户道具',
  'menu.progress': 'Mint管理',
  'menu.anchor': '主播管理',
  'menu.anchor.anchor-list': '主播列表',
  'menu.anchor.country-list': '国家列表',
  'menu.anchor.style-list': '风格列表',
  'menu.anchor.group-list': '群组列表',
  'menu.anchor.language-list': '语言列表',
