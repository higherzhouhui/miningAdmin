...
export async function rule(
  ...
  return request<{
    ...
    total?: number;
    success?: boolean;
  }>('/admin/wallet-type/getWalletTypeList', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateRule(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('/admin/wallet-type/saveOrUpdate', {
    data,
    method: 'POST',
    ...(options || {}),
  });
...
export async function removeRule(data: { id: number }, options?: { [key: string]: any }) {
  return request<Record<string, any>>(`/admin/wallet-type/delete/${data.id}`, {
    data,
    method: 'DELETE',
    ...(options || {}),
  });
