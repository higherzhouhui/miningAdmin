...
const TableList: React.FC = () => {
  const [baseInfo, setBaseInfo] = useState([
    { title: '邀请普通用户奖励积分', key: 'invite_add', value: '', type: 'number'},
    { title: '邀请普通用户奖励游戏次数', key: 'ticket', value: '', type: 'number'},
    { title: '邀请会员奖励积分', key: 'huiYuan_add', value: '', type: 'number' },
    { title: '邀请会员奖励游戏次数', key: 'huiYuan_ticket', vlaue: '', type: 'number'},
    { title: '每日游戏次数', key: 'ticket', vlaue: '', type: 'number' },
    { title: '逐年递增', key: 'one_year_add', vlaue: '', type: 'number'},
