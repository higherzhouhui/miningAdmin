...
const TableList: React.FC = () => {
  ...
  const [equityCert, setequityCert] = useState('')
  ...
  const handleOk = async () => {
    ...
    const data = {equityCert: equityCert, id: id}
  ...
  return (
    <PageContainer>
      <div className='tuiguang'>
        <WangEditor description={equityCert} onChange={(e) => handleChange(e)}/>
      </div>
