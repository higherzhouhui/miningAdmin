...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<any>[] = [
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <div className='flag'>{record.flag}</div>
        );
      },
    },
    {
  ...
  const handleOk = async () => {
    if (operationType === 'baseInfo') {
      if (!currentRow?.zh || !currentRow?.en || !currentRow?.flag) {
      ...
      <ProTable<TableListItem, TableListPagination>
        ...
        toolBarRender={() => [
          ...
          <Button
            type="primary"
            key="primary"
            onClick={() => export2Excel('accountListIndex', '国家列表')}
          >
            <TableOutlined />
            导出Excel
          </Button>,
        ...
        <ProForm formRef={formRef} submitter={false}>
          {operationType === 'baseInfo' ? (
            <>
              ...
              <Form.Item label="国家(中)">
                <Input
                  value={currentRow?.zh}
                  onChange={(e) => handleChange(e.target.value, 'zh')}
                />
              </Form.Item>
              <Form.Item label="国家(英文)">
                <Input
                  value={currentRow?.en}
              ...
              <Form.Item label="旗帜">
                <Input
                  ...
                  onChange={(e) => handleChange(e.target.value, 'flag')}
                  style={{ fontFamily: 'Flag' }}
                />
              </Form.Item>
            </>
            ...
            <>
              ...
              <Form.Item label="code(与旗帜string相同)">
                <Input
